/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 480fa99a48b14665feed7d41554fc719)
// Runtime types generated with workerd@1.20260611.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	ATTACHMENTS: R2Bucket;
	DB: D1Database;
	EMBEDDINGS: VectorizeIndex;
	EMAIL_INGESTION_QUEUE: Queue;
	CLASSIFICATION_QUEUE: Queue;
	ENTITY_EXTRACTION_QUEUE: Queue;
	ATTACHMENT_PROCESSING_QUEUE: Queue;
	EMBEDDING_GENERATION_QUEUE: Queue;
	AUTOMATION_EXECUTION_QUEUE: Queue;
	INSIGHT_GENERATION_QUEUE: Queue;
	AI: Ai;
	ENVIRONMENT: "staging" | "production" | "local";
	AI_GATEWAY_ID: "default";
	APP_URL: "https://REPLACE_WITH_STAGING_APP_URL" | "https://REPLACE_WITH_PRODUCTION_APP_URL" | "http://localhost:3000";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ENVIRONMENT: "staging";
		AI_GATEWAY_ID: "default";
		APP_URL: "https://REPLACE_WITH_STAGING_APP_URL";
		GOOGLE_OAUTH_REDIRECT_PATH: "/api/v1/auth/google/callback";
		GMAIL_PUBSUB_TOPIC: "";
		GMAIL_WEBHOOK_AUDIENCE: "";
	}
	interface ProductionEnv {
		...
		AI_GATEWAY_ID: "default";
		APP_URL: "https://REPLACE_WITH_PRODUCTION_APP_URL";
		GOOGLE_OAUTH_REDIRECT_PATH: "/api/v1/auth/google/callback";
		GMAIL_PUBSUB_TOPIC: "";
		GMAIL_WEBHOOK_AUDIENCE: "";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "AI_GATEWAY_ID" | "APP_URL" | "GOOGLE_OAUTH_REDIRECT_PATH" | "GMAIL_PUBSUB_TOPIC" | "GMAIL_WEBHOOK_AUDIENCE">> {}
}
